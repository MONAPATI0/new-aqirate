        ...
        return (
          <Layout>
            <div style={{
              ...
              <hr></hr>
              <div style={{background:"#000000",height:"100px"}}>
              <h5 className="text-center text-white" style={{ fontWeight: "robot", position: "relative", top: "49px", fontSize: '16px' }}>
                <span className="text-white"  style={{ fontWeight: "bold",color: "#000000", }}>
                  THANKS&nbsp;&nbsp;
                              </span>
            ...
            <div className="mb-5  Group" style={{ backgroundColor: "#f4f4f4", height: "200px",marginTop:"75px"}}>
              <Row>
                <Col md={3}>
            ...
            <Container className="mb-3 text-center text" style={{marginTop:"100px"}}>
              <Row>
